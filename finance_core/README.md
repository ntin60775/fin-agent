...
- **Фактический остаток — наблюдение извне.** `ObservedBalance` — остаток сделки на
  ...
  записью недостающих данных, а не правкой числа. Проверка падает на необъяснённом
  расхождении, а не на самом расхождении — его видно открытым вопросом прогноза
