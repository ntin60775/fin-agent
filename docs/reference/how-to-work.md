...
1. В финансовой зоне — записать заявку в `fin-agent/inbox/` вручную: чего не
   хватило движку (а не незаполненных данных или того, что собирается сценарием).
   Форма заявки — в [inbox/README.md](../../inbox/README.md).
